...
Consultation with the ANB (Agency for Nature and Forests) and the Department of Environment is planned for specific data.
The results of this research will be shared with the ANB, the Department of Environment, and Statistics Flanders.
In 2026 the Federal Planning Bureau, together with the statistical authorities of the regions, has launched a cross-entity working group on this topic.

The statistics on ecosystem extent cover the entire territory of Flanders and are updated every three years.
They are based on data from the Flanders Land Use Dataset, supplemented with and validated against area data collected, managed, and reported by INBO as part of various research and monitoring programs and projects.
The research into ecosystem area develops a repeatable methodology for validating ecosystem change data derived from remote sensing, including a critical evaluation based on field data and expert knowledge within INBO.

The System of Environmental-Economic Accounting—Ecosystem Accounting (SEEA EA), or "ecosystem accounts" - at least its physical modules - has been an international statistical standard of the United Nations since March 2021.
The European Commission, which contributed to this framework, developed it into  EU Regulation 2024/3024.
